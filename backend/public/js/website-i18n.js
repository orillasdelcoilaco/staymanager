    ...
    const dictionaries = {
        bookingWidget: {
            es: {
                ...
                listTariffLabel: 'Tarifa publicada',
                promoLineLabel: (name) => `Promo: ${name}`,
                promoDefault: 'Oferta tarifa',
                withOfferSuffix: ' (con oferta)',
            ...
            en: {
                ...
                listTariffLabel: 'Published rate',
                promoLineLabel: (name) => `Promo: ${name}`,
                promoDefault: 'Rate offer',
                withOfferSuffix: ' (with offer)',
