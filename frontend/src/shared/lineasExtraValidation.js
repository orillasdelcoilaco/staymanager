 ...
 * Mantener alineado con `backend/services/lineasExtraValidation.js` (misma lógica).
 */
...
export function sanitizeLineaExtraDef(row) {
 ...
 */
export function validateLineasExtraArray(raw) {
