...
export function afterRender() {
    document.getElementById('authorize-btn').addEventListener('click', async () => {
        ...
        try {
            ...
            button.textContent = 'Autorizar con Google';
        }
    });
}