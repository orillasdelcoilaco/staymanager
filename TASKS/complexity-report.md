...
**Generado:** 2026-03-21 15:56
**Archivos analizados:** 192
**Críticos:** 34 | **Warnings:** 116

---

## Resumen

### 🔴 Críticos (34) — Requieren refactorización

| Archivo | Problema | Detalle |
|---------|---------|--------|
| `frontend/src/views/components/agregarPropuesta/propuesta.ui.js` | function-size | función `renderPropuestaLayout` — 130 líneas (línea 73) |
...
| `frontend/src/views/components/gestionarReservas/reservas.modals.js` | function-size | función `abrirModalVer` — 275 líneas (línea 12) |
...
| `frontend/src/views/generadorPresupuestos.js` | function-size | función `afterRender` — 139 líneas (línea 251) |
| `frontend/src/views/gestionarPropuestas.js` | function-size | función `handleTableClick` — 175 líneas (línea 92) |
| `frontend/src/views/gestionarReservas.js` | function-size | función `render` — 210 líneas (línea 28) |
| `frontend/src/views/gestionarReservas.js` | function-size | función `afterRender` — 225 líneas (línea 239) |
| `frontend/src/views/gestionarTiposElemento.js` | function-size | función `afterRender` — 170 líneas (línea 290) |
| `frontend/src/views/perfilCliente.js` | function-size | función `render` — 135 líneas (línea 112) |
...
| `backend/services/empresaImporterService.js` | file-size | 863 líneas (límite crítico: 700) |
| `backend/services/empresaImporterService.js` | function-size | función `createEmpresaFromImport` — 356 líneas (línea 460) |
...
| `backend/services/gestionService.js` | function-size | función `getReservasPendientes` — 214 líneas (línea 16) |
| `backend/services/kpiService.js` | function-size | función `calculateKPIs` — 196 líneas (línea 9) |
| `backend/services/mensajeService.js` | function-size | función `generarTextoPropuesta` — 166 líneas (línea 50) |
| `backend/services/mensajeService.js` | function-size | función `generarTextoPresupuesto` — 126 líneas (línea 217) |
...
| `backend/services/sincronizacionService.js` | function-size | función `procesarArchivoReservas` — 172 líneas (línea 141) |
...
### 🟡 Warnings (116) — Monitorear

| Archivo | Problema | Detalle |
|---------|---------|--------|
| `frontend/src/api.js` | function-size | función `fetchAPI` — 80 líneas (línea 44) |
| `frontend/src/router.js` | function-size | función `renderMenu` — 62 líneas (línea 192) |
| `frontend/src/views/components/agregarPropuesta/propuesta.handlers.js` | file-size | 443 líneas (límite warning: 400) |
| `frontend/src/views/components/agregarPropuesta/propuesta.handlers.js` | function-size | función `runSearch` — 73 líneas (línea 122) |
| `frontend/src/views/components/agregarPropuesta/propuesta.handlers.js` | function-size | función `handleGuardarPropuesta` — 97 líneas (línea 234) |
| `frontend/src/views/components/agregarPropuesta/propuesta.handlers.js` | function-size | función `handleCargarPropuesta` — 84 líneas (línea 360) |
...
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `actualizarContadores` — 110 líneas (línea 218) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `normalize` — 86 líneas (línea 223) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `handleAgregarComponente` — 72 líneas (línea 359) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `handleGenerarEstructuraIA` — 100 líneas (línea 432) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `renderModalAlojamiento` — 106 líneas (línea 595) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `abrirModalAlojamiento` — 98 líneas (línea 702) |
| `frontend/src/views/components/gestionarAlojamientos/alojamientos.modals.js` | function-size | función `setupModalAlojamiento` — 67 líneas (línea 807) |
...
| `frontend/src/views/components/gestionarReservas/reservas.modals.js` | file-size | 426 líneas (límite warning: 400) |
| `frontend/src/views/components/gestionarReservas/reservas.modals.js` | too-many-exports | 9 funciones exportadas (límite warning: 8) |
...
| `frontend/src/views/components/gestionDiaria/modals/mensajeModal.js` | function-size | función `generarMensajePreview` — 62 líneas (línea 10) |
| `frontend/src/views/components/gestionDiaria/modals/mensajeModal.js` | function-size | función `renderMensajeModal` — 70 líneas (línea 127) |
...
| `frontend/src/views/empresa.js` | function-size | función `renderFormulario` — 92 líneas (línea 7) |
| `frontend/src/views/galeriaPropiedad.js` | function-size | función `bindGaleria` — 77 líneas (línea 228) |
| `frontend/src/views/generadorPresupuestos.js` | function-size | función `render` — 76 líneas (línea 172) |
...
| `frontend/src/views/gestionarClientes.js` | function-size | función `afterRender` — 64 líneas (línea 67) |
...
| `frontend/src/views/gestionarReservas.js` | file-size | 463 líneas (límite warning: 400) |
| `frontend/src/views/gestionarTarifas.js` | function-size | función `render` — 99 líneas (línea 21) |
...
| `frontend/src/views/gestionDiaria.js` | function-size | función `afterRender` — 72 líneas (línea 167) |
...
| `frontend/src/views/mapeoReportes.js` | function-size | función `render` — 83 líneas (línea 172) |
| `frontend/src/views/perfilCliente.js` | function-size | función `afterRender` — 74 líneas (línea 248) |
...
| `backend/services/clientesService.js` | function-size | función `crearOActualizarCliente` — 70 líneas (línea 27) |
| `backend/services/clientesService.js` | function-size | función `recalcularEstadisticasClientes` — 88 líneas (línea 222) |
...
| `backend/services/empresaImporterService.js` | function-size | función `importarGaleriaPropiedad` — 109 líneas (línea 219) |
| `backend/services/empresaImporterService.js` | function-size | función `buildComponentes` — 62 líneas (línea 329) |
...
| `backend/services/icalService.js` | function-size | función `sincronizarCalendarios` — 108 líneas (línea 52) |
| `backend/services/kpiService.js` | function-size | función `procesarReserva` — 65 líneas (línea 90) |
| `backend/services/mensajeService.js` | file-size | 427 líneas (límite warning: 400) |
| `backend/services/mensajeService.js` | function-size | función `generarTextoReporte` — 75 líneas (línea 345) |
| `backend/services/plantillasService.js` | too-many-exports | 13 funciones exportadas (límite warning: 8) |
| `backend/services/propiedadesService.js` | function-size | función `crearPropiedad` — 83 líneas (línea 22) |
| `backend/services/propiedadesService.js` | function-size | función `actualizarPropiedad` — 65 líneas (línea 148) |
| `backend/services/propiedadesService.js` | function-size | función `clonarPropiedad` — 91 líneas (línea 245) |
| `backend/services/propiedadLogicService.js` | function-size | función `generarPlanFotos` — 76 líneas (línea 107) |
| `backend/services/propuestasService.js` | function-size | función `getAvailabilityData` — 102 líneas (línea 7) |
| `backend/services/publicWebsiteService.js` | function-size | función `getAvailabilityData` — 67 líneas (línea 203) |
| `backend/services/publicWebsiteService.js` | function-size | función `calculatePrice` — 64 líneas (línea 296) |
...
| `backend/services/tarifasService.js` | function-size | función `obtenerTarifasPorEmpresa` — 79 líneas (línea 54) |
| `backend/services/usuariosService.js` | too-many-exports | 9 funciones exportadas (límite warning: 8) |
...
- **función `actualizarContadores` — 110 líneas (línea 218)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `normalize` — 86 líneas (línea 223)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `handleAgregarComponente` — 72 líneas (línea 359)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `handleGenerarEstructuraIA` — 100 líneas (línea 432)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `renderModalAlojamiento` — 106 líneas (línea 595)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `abrirModalAlojamiento` — 98 líneas (línea 702)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `setupModalAlojamiento` — 67 líneas (línea 807)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.

### 2. `backend/services/empresaImporterService.js` 🔴
- **863 líneas (límite crítico: 700)**
  - Dividir en módulos por responsabilidad. Cada módulo debe tener una sola razón para cambiar.
- **función `createEmpresaFromImport` — 356 líneas (línea 460)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `importarGaleriaPropiedad` — 109 líneas (línea 219)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
- **función `buildComponentes` — 62 líneas (línea 329)**
  - Extraer sub-funciones con nombres descriptivos. Máximo 60 líneas por función.
