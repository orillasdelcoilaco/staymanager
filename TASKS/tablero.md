...
| `SM-fotos-galeria` | Fotos, galería, IMG-001, baños | Listo | — | `tema/SM-fotos-galeria` | — | 2026-05-05 — Validación estricta full+thumb (`imageUploadGuards`), sync sin thumb degradado, upload wizard→galería único, audit-slot exige miniatura en BD | `galeriaService.js`, `config.routes.js`, `webPublica.galeria.wizard.js` |
