...
| `SM-recontacto-sin-disponibilidad` | Recontacto automático a clientes sin disponibilidad | Bloqueado | — | `tema/SM-recontacto-sin-disponibilidad` | Ops / integrador | 2026-05-05 — **Código listo**; falta solo humano con acceso: migración `espera-disponibilidad.sql` en prod + deploy Render + reimport OpenAPI 1.4.8 en ChatGPT + smoke (`plan-cierre-deploy-ops.md`) | `tema/SM-recontacto-sin-disponibilidad/plan-cierre-deploy-ops.md`, `README.md`, `plan-accion-recontacto-sin-disponibilidad.md` |
