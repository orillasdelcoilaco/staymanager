...
| `SM-recontacto-sin-disponibilidad` | Recontacto automático a clientes sin disponibilidad | En curso (Claude u otro) | — | `tema/SM-recontacto-sin-disponibilidad` | Claude Code | 2026-05-05 — Migración SQL corregida (UUID→TEXT) y ejecutada en prod; pendiente deploy Render (push) + reimport OpenAPI 1.4.8 en ChatGPT + smoke A–E | `tema/SM-recontacto-sin-disponibilidad/plan-cierre-deploy-ops.md`, `README.md`, `plan-accion-recontacto-sin-disponibilidad.md` |
