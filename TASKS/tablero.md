...
|----|---------------|---------|------|--------------|-------------|---------------------|---------|
| `SM-blog-publico` | Blog SSR por empresa (sugerencias datos + IA + panel) | Listo | — | `tema/SM-blog-publico` | Cursor | 2026-05-05 — MVP: migración `website-blog-posts`, API `/api/website/blog/*`, SSR `/blog`, sitemap, SPA `/website-blog`, `BLOG_POST_DRAFT` + límite IA | `tema/SM-blog-publico/README.md` |
