...
|----|---------------|---------|------|--------------|-------------|---------------------|---------|
| `SM-pagespeed-lighthouse-max` | Core Web Vitals / Lighthouse máximo (SSR tenant + suitemanagers.com) | En curso (Cursor) | — | `tema/SM-pagespeed-lighthouse-max` | Cursor | 2026-05-05 — Concierge IA: `chat.js` async tras scroll o idle (~4,5s); FA + thumbnails como antes | `tema/SM-pagespeed-lighthouse-max/README.md`, `audit-causas-raiz.md` |
