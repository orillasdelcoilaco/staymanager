...
| `SM-pagespeed-lighthouse-max` | Core Web Vitals / Lighthouse máximo (SSR tenant + suitemanagers.com) | En curso (Cursor) | — | `tema/SM-pagespeed-lighthouse-max` | Cursor | 2026-05-06 — WhatsApp success-700 (contraste); img card/group `onerror` placeholder si Storage 403; hero thumb q58 | `header.ejs`, `footer.ejs`, `property-card.ejs`, `home.ejs`, `webImagesRepairService.js` |
