...
```
OpenClaw edita TASKS/tema/SM-operacion-agentes/pending.md → commit + push a main
        ↓
...
Pablo abre Claude Code → escribe "revisar tareas pendientes"
        ↓
Antigravity implementa → actualiza TASKS/tema/SM-operacion-agentes/completed.md → push a main
        ↓
...
1. Editar `TASKS/tema/SM-operacion-agentes/pending.md` con el hallazgo usando el formato indicado en ese archivo
2. Hacer commit y push a `main`
3. Pablo recibe notificación push en el celular
4. Antigravity implementa y actualiza `TASKS/tema/SM-operacion-agentes/completed.md`
...
**Repositorio:** [https://github.com/admin-rezerva/rezerva](https://github.com/admin-rezerva/rezerva)
