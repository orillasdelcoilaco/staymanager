...
- `suitemanagers.com` (sitio de plataforma/marketplace).
...
- **`suitemanagers.com` (marketplace / SEO de la plataforma):** va en un **apartado de menú propio**, pensado como **vista de plataforma**, no como algo “por empresa” en el día a día del tenant.
...
- Nuevo apartado de plataforma (solo superadmin): **Plataforma SuiteManagers -> Buscadores plataforma**.
...
- Estrategia de indexación separada:
  - Dominio plataforma (`suitemanagers.com`).
