 ...
 *
 * Uso: node scripts/tooling/audit-complexity.js
 * Output: TASKS/tema/SM-auditoria-calidad/complexity-report.md
 */

const fs   = require('fs');
const path = require('path');

const REPORT_PATH = path.join(__dirname, '..', '..', 'TASKS', 'tema', 'SM-auditoria-calidad', 'complexity-report.md');
...
console.log(`📄 Reporte: TASKS/tema/SM-auditoria-calidad/complexity-report.md`);
