 ...
 *
 * Uso: node scripts/tooling/audit-ui.js
 * Output: TASKS/tema/SM-auditoria-calidad/audit-report.md
 */
...
const REPORT_PATH   = path.join(__dirname, '..', '..', 'TASKS', 'tema', 'SM-auditoria-calidad', 'audit-report.md');
...
console.log(`📄 Reporte guardado en: TASKS/tema/SM-auditoria-calidad/audit-report.md`);
