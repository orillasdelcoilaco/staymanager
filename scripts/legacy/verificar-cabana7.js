...
console.log('1. Ejecutar auditoría de complejidad: node scripts/tooling/audit-complexity.js');
console.log('2. Ejecutar auditoría UI: node scripts/tooling/audit-ui.js');
