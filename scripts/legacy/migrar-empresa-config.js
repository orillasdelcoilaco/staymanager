/**
 * scripts/legacy/migrar-empresa-config.js
 *
 ...
 *
 * Uso:
 *   node scripts/legacy/migrar-empresa-config.js --email=orillasdelcoilaco@gmail.com
 *   node scripts/legacy/migrar-empresa-config.js --empresaId=abc123
 *
...
async function main() {
    if (!emailArg && !idArg) {
        console.error('Uso: node scripts/legacy/migrar-empresa-config.js --email=xxx  o  --empresaId=xxx');
        process.exit(1);
    }
