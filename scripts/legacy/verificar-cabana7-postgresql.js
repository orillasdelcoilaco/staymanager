...
async function verificarCabana7() {
    ...
    try {
        ...
        if (tieneProblemas) {
            ...
            console.log('   node scripts/legacy/reparar-capacidad-postgresql.js 1');
            console.log('\n2. Verificar después de la reparación:');
            console.log('   node scripts/legacy/verificar-cabana7-postgresql.js');
        } else {
...
if (!process.env.DATABASE_URL) {
    ...
    console.log('   Ejemplo: DATABASE_URL=postgresql://... node scripts/legacy/verificar-cabana7-postgresql.js');
    process.exit(1);
}
