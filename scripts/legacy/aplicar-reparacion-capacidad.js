...
async function main() {
    ...
    if (process.env.DATABASE_URL) {
        ...
        console.log('📋 Use las instrucciones en scripts/legacy/reparar-capacidad-datos.js');
...
`);
    ...
    console.log('4. Ejecutar node scripts/legacy/verificar-cabana7.js para validar');
